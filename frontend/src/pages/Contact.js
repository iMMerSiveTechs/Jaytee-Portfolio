              ...
              >
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <button
                    ...
                    type="submit"
                    disabled={submitting}
                    className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-white text-black text-sm font-bold hover:bg-white/92 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {submitting
                      ? <><span className="w-3.5 h-3.5 rounded-full border-2 border-black/20 border-t-black/70 animate-spin" /> Sending…</>
                      : <><span>Send this</span><ArrowUpRight size={14} /></>}
                  </button>
                </div>
              </form>
            )}
