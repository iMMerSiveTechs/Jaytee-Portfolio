...
/**
 * Social sharing buttons for notes and articles.
 * Uses native share URLs — no third-party SDKs.
 */

function ShareButton({ href, onClick, label, icon: SvgIcon, color }) {
...
// SVG icon components for social platforms (inline, no external deps)
...
export function SocialShare({ title, url, excerpt }) {
